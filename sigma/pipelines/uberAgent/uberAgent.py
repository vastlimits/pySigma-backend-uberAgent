...
@Pipeline
def uberAgent_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="uAQL example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"uberAgent_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="uberAgent_field_mapping",
